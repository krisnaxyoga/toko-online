        ...
        <div class="container">
            <div class="row p-b-148">
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="https://d3uyff779abz3k.cloudfront.net/-baliya-/images/480/Songket-Dan-Selendang-Bali-Asli-Negara.jpg"
                                alt="IMG">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="https://cdn.antaranews.com/cache/1200x800/2021/05/27/Putri-Koster-tenun.jpg"
                                alt="IMG">
                        </div>
                    </div>
                </div>
